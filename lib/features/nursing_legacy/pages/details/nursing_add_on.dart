...
import 'package:m2health/features/nursing_legacy/pages/search_professional_page.dart';
  ...
  Future<void> fetchServices() async {
    ...
    try {
      ...
      final response = await Dio().get(
        ...
        queryParameters: {'service_type': serviceType.apiValue},
